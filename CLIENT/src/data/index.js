...
const MessageMenuItems = [
  {
    id: 0,
    icon: <ArrowBendUpLeft weight="fill"/>,
    text: "Reply",
  },
  {
    id: 1,
    icon: <ArrowBendUpRight weight="fill"/>,
    text: "Forward",
  },
  {
    id: 2,
...
const MessageActions = [
  ...
  {
    color: "primary.light",
    icon: <Sticker size={24} weight="fill"/>,
    title: "Stickers",
  },
  {
    color: "primary.main",
...
const SettingsOptions = [
  {
    id: 0,
    icon: <Bell size={21} weight="fill"/>,
    text: "Notificatios",
    action: "NOTIFICATION_SETTINGS"
  },
  {
    id: 1,
    icon: <Lock size={21} weight="fill"/>,
    text: "Privacy",
    action: "PRIVACY_SETTINGS"
  },
  {
    id: 2,
    icon: <Key size={21} weight="fill"/>,
    text: "Security",
    action: "SECURITY_SETTINGS"
  },
  {
    id: 3,
    icon: <PencilCircle size={21} weight="fill"/>,
    text: "Theme",
    action: "THEME_SETTINGS"
  },
  {
    id: 4,
    icon: <Image size={21} weight="fill"/>,
    text: "Chat wallpaper",
  ...
  {
    id: 6,
    icon: <Keyboard size={21} weight="fill"/>,
    text: "Keyboard shortcuts",
    action: "KEYBOARD_SHORTCUT_SETTINGS"
  },
  {
    id: 7,
    icon: <Info size={21} weight="fill"/>,
    text: "Help", 
...
// FIXME: Template Data Only for development
